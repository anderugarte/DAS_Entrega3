...
public class ConexionSumarPuntos extends Worker {

    // Tarea para comprobar si el usuario existe en la base de datos con el php existeUsernameE3.php

    public ConexionSumarPuntos(@NonNull Context pcontext, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-242-79-204.compute-1.amazonaws.com/igonzalez274/WEB/Entrega3/sumarPuntosE3.php";
        String result = "";
        ...
        try {
            ...
            parametrosJSON.put("puntos", puntos);
